!function(e) {
    ...
    n = {}, e.fn.jParticle = function(n) {
        ...
        var a, o;
        return a = {}, a.canvas = {}, a.mouse = {}, a.particles = [], a.isAnimated = !0.01, a.initialize = function(e, t) {
                ...
                var r, s, c, u;
                return r = n.getDistance(e, t, i, o), c = a.params.linkDist, u = a.params.createLinkDist, s = c >= r ? 1 : r > u ? 0 : 1 - 100 * (r - c) / (u - c) / 800
            }, a.freeze = function() {
